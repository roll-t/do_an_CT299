...
if(isset($_POST["product_detail_add"])){
    ...
    // INSERT INTO `chitiet_sanpham` (`SP_ID`, `CHL_ID`, `CSP_IMG_1`, `CSP_KICHTHUOC`, 
    // `MS_ID`, `CSP_IMG_2`, `CSP_IMG_3`, `CSP_IMG_4`,
    //  `CSP_MOTA`) VALUES ('23', '2', 'img-1', '12,3,100', '2', 'img-2', 'img-3', 'img-4', 'hello');
    if($upload_detail_ok){
        ...
        VALUES ('".$id_pd."', '".$material."', '".$arr_img[0]."', '".$arr_size."', 
         '".$color."', '".$arr_img[1]."', '".$arr_img[3]."', '".$arr_img[2]."', '".$des_detail."')";
