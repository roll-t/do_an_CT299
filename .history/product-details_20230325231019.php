                    ...
                    echo '    <div class="ctl"><p>Danh mục: </p> <span>Ghế ngoài trời, ngoại thất</span></div>';
                       ...
                       <div class="add-cart">
                        ...
                        <div class="btn-by-now">
                            <a style="color:white;" href="./checkout.php">Mua Ngay</a>
                        </div>
                            <div class="btn-add-cart">
                            <?php
                            echo'<a style="border:none" class="btn-add-cart" href="./cart/add-cart.php
                                ?id_product='.$id_product.'&img_product='.$main_img.'&name_product='.$name_product.'&price_product='.$product_price.'
                                ">
                                    Thêm Vào Giỏ
                                </a>
                            </div>';
