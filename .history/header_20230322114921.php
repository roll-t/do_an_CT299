    ...
    <div class="headline">
                ...
                <div class="right-headline">
                  <?php include './search.php'?>
                    ...
                    $name_account=isset($_COOKIE["account_homedesign"])?$_COOKIE["account_homedesign"]:'./account.php';
                    ?>
                    <a href=<?php echo $link?> class="account"><ion-icon name="person-circle-outline"></ion-icon><h3>Tài Khoản</h3></a>
                </div>
    </div>
