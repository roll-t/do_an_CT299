...
if(!isset($_COOKIE["account_homedesign"])) {
  echo "Cookie named '" . "account_homedesign" . "' is not set!";
} else {
  echo "Cookie '" . "account_homedesign" . "' is set!<br>";
  echo "Value is: " . $_COOKIE["account_homedesign"];
}
?>
       ...
       <div class="row">
          ...
          <div class="col-sm-6 form">
             ...
             <div class="login form-peice  switched">
                <form class="login-form" method="post" action="./client/login-account.php">
             ...
             <div class="signup form-peice">
                <form class="signup-form" method="post" action="./client/signup-account.php">
                  ...
                  <a href="./client/check-name-login.php?name_login" class="link-check-account-login" style="position:absolute;"></a>
                  <a href="./client/check-name-login.php?password_login" class="link-check-password-login" style="position:absolute;"></a>
                  <a href="./client/check-name-login.php?confirm_password" class="link_confirm_password"></a>
               </div><!-- End Signup Form -->
          </div>
       </div>
    </section>
