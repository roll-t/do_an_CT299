...
foreach($result_all as $row){
    ...
    $sql_2 ="SELECT * FROM `product_categories` as a JOIN `catalog_list` as b WHERE a.id_catalog_list=b.id and a.id_catalog_list=$row[0]";
    $result_2=$conn->query($sql_2);
    $result_all_2=$result_2->fetch_all();
    array_push($menu_2,$result_all_2[$count])
