    ...
    <div class="headline">
                ...
                <div class="right-headline">
                  <?php include './search.php'?>
                    ...
                    <?php
                    $link=isset($_COOKIE["account_login"])?'./profile.php':'./account.php';
                    ?>
                    <a href=<?php echo $link?> class="account"><ion-icon name="person-circle-outline"></ion-icon><h3>Account</h3></a>
                </div>
    </div>
