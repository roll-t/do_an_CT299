<?php
        ...
        if(isset($_POST["add_catalog_list"])){
            if(!empty($_POST["name_catalog_list"])){
                $sql="INSERT INTO `nhom_danhmuc` (`id`, `name_catalog_list`) VALUES (NULL, '".$_POST["name_catalog_list"]."');";
        ...
        if(isset($_POST["detele_catalog_list"])){
            $sql_dl="SELECT * FROM `danhmuc` as a JOIN `nhom_danhmuc` as b WHERE a.id_catalog_list=b.id and a.id_catalog_list='".$_POST["value_select"]."'";
