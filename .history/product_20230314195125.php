    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                if($page_items>=4){
                    echo '      <a href="./paging/paging-product.php?page='.($count_index).'/count_index='.$count_index.'" class="page-items page-next"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
                }
