        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                <ul class="list-product main-list-product">
                    ...
                    render_list_product($arr_product[0]);
                    ?>
                </ul>
                <?php
                $count_page=$conn->query("SELECT COUNT(*) from `sanpham`")->fetch_assoc();
                // var_dump($count_page);
                    echo '      <div class="padding">';
                    if($index>1){
                        echo '      <a href="./paging/paging-product.php?page=0" class="page-items next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
                    }
                    echo '      <a href="./paging/paging-product.php?page=0" class="page-items">1</a>';
                    echo '      <a href="./paging/paging-product.php?page=0" class="page-items">2</a>';
                    echo '      <a href="./paging/paging-product.php?page=0" class="page-items">3</a>';
                    echo '      <div class="texture">.....</div>';
                    echo '      <a href="./paging/paging-product.php?page=0" class="page-items prve"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
                    echo '  </div>';
