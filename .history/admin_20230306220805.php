...
<header><span class="logo">Home<span style="color:darkorange">Design</span></span>
    ...
    <div class="warp">
        ...
        <div class="right-side">
            ...
            <div class="body-add-category body-add-product active">
                <form action="./add-product.php" method="post" class="group-input">
                    ...
                    <div class="info-product-add">
                        <div class="left-side-add add-product">
                            ...
                            <div class="wrap-input">
                                ...
                                <input type="number" name="name-product" placeholder=".....VDN">
                            </div>
                            <div class="wrap-input">
                            ...
                            <div class="wrap-input">
                                <label for="name-product">Thêm ảnh 1</label>
                                <input type="file" name="name-product" placeholder="Nhap vao ten san pham">
                            </div>
                            <div class="wrap-input">
                                <label for="name-product">Thêm ảnh zoom</label>
                                <input type="file" name="name-product" placeholder="Nhap vao ten san pham">
                            </div>
                            <div class="wrap-input">
