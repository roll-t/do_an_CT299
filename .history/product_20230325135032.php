            ...
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                <ul class="list-product main-list-product">
                    ...
                    function render_list_product($arr_product){
                        ...
                        echo '                                    <a style ="color:white;display:flex;gap:5px;" class="btn-add-cart" href="./cart/add-cart.php?id_product='.$items[0].'"><ion-icon name="cart-outline"></ion-icon>';
                        echo '                                    <p>Add to cart</p></a>';
                        echo '                                </div>';
