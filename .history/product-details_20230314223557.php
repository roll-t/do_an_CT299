...
$sql_product="SELECT * from `chitiet_sanpham` JOIN `sanpham` on `sanpham`.SP_ID=`chitiet_sanpham`.SP_ID WHERE `chitiet_sanpham`.SP_ID=38";

$result_product=$conn->query($sql_product);

$arr_product=$result_product->fetch_assoc();

$main_img=$arr_product["SP_IMG_1"];
$arr_img=[$arr_product["CSP_IMG_1"],$arr_product["CSP_IMG_2"],$arr_product["CSP_IMG_3"],$arr_product["CSP_IMG_4"]];
        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product product-detail">
                ...
                <div class="body-detail">
                    ...
                    echo '    <div class="product-price"><ion-icon name="heart-outline"></ion-icon><span>'.$product_price.'</span><p>VND</p></div>';
                    echo '    <div class="material"><p class="title-material">Vật Liệu: </p><span>Nhôm</span></div>';
                    echo '    <div class="size"><p class="title-size">Kích Thước: </p> <span>D'.$arr_size[0].' - R'.$arr_size[1].' - C'.$arr_size[2].' mm</span></div>';
                    echo '    <div class="des-1"><p>Hàng sẳn có:</p><a href="#">Xem cửa hàng trưng bày</a></div>';
                    echo '    <div class="id-product"><p>Mã:</p><span>'.$arr_product["SP_ID"].'*109228</span></div>';
