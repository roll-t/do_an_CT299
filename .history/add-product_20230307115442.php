...
if(isset($_POST["confirm_add_product"])){
    ...
    function insert_product(){
        ...
        $room_id=$_POST["room_id_add_product"];
       ...
       $sql=" INSERT INTO `sanpham` (`SP_ID`, `DM_ID`, `P_ID`, `SP_TEN`, `SP_GIA`, `SP_IMG_1`, `SP_IMG_2`) 
              VALUES (NULL, '".$cate_id."', '".$room_id."', '".$name_product."', '".$price_product."', '". $target_file_1."', '". $target_file_2."') ";
       $add=$conn->query($sql);
