...
<div class="container">
       ...
       <div class="row">
          ...
          <div class="col-sm-6 brand">
             ...
             <div class="success-msg">
                ...
                <a href="./profile.html" class="profile">Your Profile</a>
             </div>
          </div>
          ...
          <div class="col-sm-6 form">
             ...
             <div class="signup form-peice">
                <form class="signup-form" action="#" onsubmit="return false" >
                   ...
                   <div class="CTA">
                      <input type="submit" class="btn_signup" value="Signup Now" >
    ...
    <footer>
       <p>
         Contact us: <a href="#" target="_blank">groupthree@gmail.com</a>
       </p>
    </footer>
