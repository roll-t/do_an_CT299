...
function show_list($arr){
  ...
  if(count($arr)>0){  
    ...
    echo '      <div class="delete-confirm" ><a class="delete-now" href="#" ><ion-icon name="trash"></ion-icon></a></div>';
    echo '  </div>';
    echo '</li>';
    }
      ...
      echo '<script src="./assets/javascript/confirm-delete-product.js"></script>';
  }else{
