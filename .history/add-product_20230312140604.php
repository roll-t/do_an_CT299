...
function confirm_change_info_product(){
    ...
    if(isset($_POST["change_info_product"])){
       ...
       if($change_info_ok){
        $sql_insert_product="UPDATE `sanpham` SET `DM_ID` = '".$cate_id."',`P_ID`='".$rooms_id."' ,`SP_TEN` = 'Ghế phòng khách', `SP_GIA` = '1323',
         `SP_IMG_1` = '".$link_img_1."', `SP_IMG_2` ='".$link_img_1."', `SP_DES` = 'đá' WHERE `sanpham`.`SP_ID` = 22";
       }
