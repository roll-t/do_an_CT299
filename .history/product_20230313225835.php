    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                echo '      <a href="./paging/paging-product.php?page=0" class="page-items page-per"><ion-icon name="chevron-back-outline"></ion-icon></a>';
                echo '      <div class="texture-1">.....</div>';   
                for($i=$index;$i<=$index+2;$i++){
                        echo '      <a href="./paging/paging-product.php?page='.$i.'" class="page-items page-index">'.$i .'</a>';
                               }
                    echo '      <div class="texture-2">.....</div>';
                    echo '      <a href="./paging/paging-product.php?page='.($quantity_page).'" class="page-items page-next"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
