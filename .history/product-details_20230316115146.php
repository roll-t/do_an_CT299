...
<body>
    ...
    <?php
        ...
        $sql_default="SELECT * from `chitiet_sanpham` JOIN `sanpham` on `sanpham`.SP_ID=`chitiet_sanpham`.SP_ID WHERE `chitiet_sanpham`.SP_ID=$id_product";
        $arr_product=select_value($sql_product);
