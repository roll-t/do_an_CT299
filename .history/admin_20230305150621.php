...
<header><span class="logo">Home<span style="color:darkorange">Design</span></span>
    ...
    <div class="warp">
        ...
        <ul class="menu">
            ...
            <li class="menu-items kho">
                <p>Quản Lý kho hàng</p>
                  <div class="category">
                    <div class="category-items">Thống kê hàng tồn kho</div>
                  </div>
            </li>
        ...
        <div class="right-side">
            ...
            <div class="body-add-category body-order active">
                ...
                <div class="body-see-order body_2 enty"> 
                    <div class="add-lo">
                    <div class="head">
                        <div class="items">Mã sản phẩm</div>
                        <div class="items">Tên sản phẩm</div>
