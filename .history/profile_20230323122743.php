                            ...
                            <div class="left">
                                <form action="#" method="get" >
                                    <div class="group-input input-validate">
                                        ...
                                        $name_client=isset(explode(",",$_COOKIE["account_homedesign"])[2])?$_COOKIE["account_homedesign"]:false;
                                        if($name_client){
                                            echo '<div class="name_client">'.explode(",",$_COOKIE["account_homedesign"])[1].'</div>';
                                        }else{
                                    ...
                                    <div class="confrim-info">
                                        <a href="./profile/info-profile.php?add_name" class="btn_confirm_info">Luu</a>
