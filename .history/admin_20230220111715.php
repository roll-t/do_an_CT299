                ...
                <form action="./add_category.php" method="post" class="group-input">
                    <div class="wrap-input">
                       ...
                       echo '<select name="value_select" class="select_catalog_list">';
                        ...
                        echo 'const select=show.querySelector(".select_catalog_list")';
                        echo 'const detele=show.querySelector(".detele-catalog-list")';
                        echo 'detele.disabled=true';
                        echo 'select.addEventListener("change",e=>{';
                        echo '   const value_items=()=>(select.value)';
                        echo '   detele.disabled=false';
                        echo '})';
                        echo '</script>';
                        foreach($result_all as $row){
                            echo "<option value=".$row[0].">".$row[1]."</option>";
