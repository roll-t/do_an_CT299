...
function confirm_change_info_product(){
    ...
    if(isset($_POST["change_info_product"])){
       ...
       !check_img("img-1") && $link_img_1=$arr_img['SP_IMG_1'];
       !check_img("img-2") && $link_img_2=$arr_img['SP_IMG_2'];


       var_dump($link_img_1);
       
       if(!isset($link_img_1)){
        check_img($img_1) && $img_ok=true;
       }

       if(!isset($link_img_2)){
        check_img($img_2) && $img_ok=true;
       }
       var_dump($img_ok);
       if($img_ok){
        echo "uploas img success";
       }
