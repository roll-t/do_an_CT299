...
$sql_ss="SELECT * FROM `product_categories` as a JOIN `catalog_list` as b WHERE a.id_catalog_list=b.id and a.id_catalog_list= '<script>document.write(localStorage.getItem('key_select'))</script>'";
