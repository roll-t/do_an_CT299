                ...
                <div class="left-menu">
                    ...
                    <ul class="list-menu-left">
                        <li class="items-menu-left">
                            <span><?php echo $result_all[0][1];?></span><ion-icon name="chevron-down-outline"></ion-icon>
                            <ul class="list-menu-chilrent">
                                <?php 
                                $sql_2 ="SELECT * FROM `product_categories` as a JOIN `catalog_list` as b WHERE a.id_catalog_list=b.id and a.id_catalog_list=15";
                                $result_2=$conn->query($sql_2);
                                $result_all_2=$result_2->fetch_all();
                                foreach($result_all_2 as $items){
                                    echo '<li class="menu-chilrent-items">';
                                    echo '<a href="#">'.$items[1].'</a>';
                                    echo '</li>';
                                }
                                ?>
                            </ul>
