    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                <div class="padding">
                    <a href="#" class="page-items next"><ion-icon name="chevron-back-outline"></ion-icon></a>
                    <a href="#" class="page-items">1</a>
                    <a href="#" class="page-items">2</a>
                    <a href="#" class="page-items">3</a>
                    <div class="texture prve">.....</div>
                    <a href="#" class="page-items"><ion-icon name="chevron-forward-outline"></ion-icon></a>
                </div>
