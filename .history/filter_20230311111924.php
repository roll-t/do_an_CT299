...
function show_list($arr){
  ...
  if(count($arr)>0){  
    ...
    if(count($arr)>=10){
      ...
      echo '   <a href="./filter.php?next-page='.$index_prve.'" class="next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
      echo '  <a href="./filter.php?prve-page=.$index_next." class="next"><ion-icon name="chevron-forward-outline"></ion-icon></ion-icon></a>';
      echo '   </div>';
      }
