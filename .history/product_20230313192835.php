            ...
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                <ul class="list-product">
                    ...
                    function render_list_product($arr_product){
                        ...
                        if(count($arr_product)>=$quantity_page){
                            echo "";
                        }
                ...
                <?php
                 ...
                 echo '      <a href="#" class="page-items next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
                 echo '      <a href="#" class="page-items">1</a>';
                 echo '      <a href="#" class="page-items">2</a>';
                 echo '      <a href="#" class="page-items">3</a>';
                 echo '      <div class="texture">.....</div>';
                 echo '      <a href="#" class="page-items prve"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
                 echo '  </div>';
                ?>
