                ...
                <form action="./add-product.php" method="post" enctype="multipart/form-data" class="group-input">
                    ...
                    <div class="address-save">
                        ...
                        <div class="wrap-input">
                           ...
                           <select name="select_value category-pd cate_id_add_product" class="detele-catalog-list">
                            <?php 
                        ...
                        <div class="wrap-input">
                           ...
                           <select name="select_value category-pd room_id_add_product" class="detele-catalog-list">
                           <?php 
                            foreach($result_all_3 as $row){
                               echo "<option value=".$row[0].">".$row[1]."</option>";
                            }
