       ...
       <div class="row">
          ...
          <div class="col-sm-6 form">
             ...
             <div class="login form-peice  switched">
                <form class="login-form" onsubmit="return true">
             ...
             <div class="signup form-peice">
                <form class="signup-form" method="post" action="./client/signup-account.php">
                   ...
                   <div class="CTA">
                      <input name="singn_up_account" type="submit" class="btn_signup" value="Signup Now" >
                      <a href="./client/check-name-account.php?name_account" class="switch confirm-account">I have an account</a>
                   </div>
                </form>
