    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                $page_items=ceil(($count_page["total"]) / 3);
                    ...
                    echo '      <div class="texture">.....</div>';
                    echo '      <a href="./padding/padding-product.php?page='.($index+1).'" class="page-items prve"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
                    echo '  </div>';
