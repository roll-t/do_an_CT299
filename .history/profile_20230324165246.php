                            ...
                            <div class="left">
                                <form action="#" method="get" >
                                    ...
                                    <div class="group-input input-validate">
                                        ...
                                        <select class="huyen" disabled name="" id="">
                                    ...
                                    <div class="group-input input-validate">
                                        <span>Địa Chỉ</span>
                                        <textarea placeholder="Ấp/xã/đường/số nhà  ...." name="" id="" cols="10" rows="3"></textarea>
                                        <span class="error"></span>
                                    </div>
