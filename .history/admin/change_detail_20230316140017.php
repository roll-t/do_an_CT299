...
function add_detail(){
    ...
    if(isset($_POST['product_detail_change'])){
        ...
        if($upload_detail_ok){
            $sql="UPDATE `chitiet_sanpham` SET `CSP_IMG_1` = 'eqweqw', `CSP_KICHTHUOC` = '100,100,100', `CSP_IMG_2` = '.sfdd', `CSP_IMG_3` = 'adsd', `CSP_IMG_4` = 'as', `CSP_MOTA` = 'rhe' WHERE `chitiet_sanpham`.`SP_ID` = 2";
        }
    }
