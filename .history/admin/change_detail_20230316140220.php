...
function add_detail(){
    ...
    if(isset($_POST['product_detail_change'])){
        ...
        if($upload_detail_ok){
            $sql="UPDATE `chitiet_sanpham` SET `CSP_IMG_1` ='".target_img($arr_img[1])."', `CSP_KICHTHUOC` = 
            '100,100,100', `CSP_IMG_2` = '".target_img($arr_img[2])."', `CSP_IMG_3` ='".target_img($arr_img[3])."', `CSP_IMG_4` = '".target_img($arr_img[4])."', 
