const btn_add_color=document.querySelector(".body-color .add-color")
const list_color=document.querySelector(".body-color .main-body .list-color")
...
const btn_delete_material=document.querySelectorAll(".body-color .list-color .delete-color ion-icon")
const id_material=document.querySelectorAll(".id_color")
...
btn_delete_material.forEach((items,index)=>{
    items.addEventListener("click",e=>{
        ...
        if(confirm(text)){
            link.href=`./add-color-material.php?delete_color=${id_material[index].value}`;
        }
    })
})
               
const btn_change_material =document.querySelectorAll(".body-color .list-color .change-color ion-icon")
