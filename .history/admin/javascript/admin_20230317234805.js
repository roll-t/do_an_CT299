...
function search_list_product(){
    const input=document.querySelector(".form-search-product .search input:nth-child(2)")
    $(".form-search-product .search input:nth-child(2)").click(function(){
        return false;
    })
    function search(){
        $(".form-search-product .search .confirm-search").click(function(){
