...
const input_search_admim=document.querySelector(".body-detele-product .search input")

const link=document.querySelector(".body-detele-product .sort_product_detail .btn-confirm-search");
console.log(input_search_admim)
if(input_search_admim.value!=""){
