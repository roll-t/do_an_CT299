...
<body>
    ...
    <div class="warp">
        ...
        <div class="body-add-category body-add-product body-detele-product">
            <form action="filter.php" enctype="multipart/form-data" method="post" class="group-input">
                <span>Tìm Kiếm</span>
                <div class="address-save">
                    <div class="wrap-input">
                ...
                <div class="product-detele">
                    <div class="form-search-product">
                        ...
                        <div class="search">
                            ...
                            <a class="confirm-search" style="position:absolute" href="filter.php?confirm_search"></a>
                        </div>
                    </div>
