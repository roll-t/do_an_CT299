...
<body>
    ...
    <div class="warp">
        ...
        <div class="body-add-category body-add-product body-detele-product">
            <form action="./add-product.php" enctype="multipart/form-data" method="post" class="group-input">
                <span>Tìm Kiếm</span>
                <div class="address-save">
                    <div class="wrap-input">
                ...
                <div class="product-detele">
                    ...
                    <form class="form-search-product" action="" method="get" >
                        <input name="search_result" type="text" placeholder="Nhập tên sản phẩm"> <input name="btn_search" type="submit" value="Tìm Kiếm">
                    </form>
