                            ...
                            <div class="left">
                                <form action="#" method="get" >
                                    ...
                                    <div class="group-input gender input-validate">
                                        ...
                                        ?>
                                        <p>
                                            <span><label for="gender">Nam</label><input name="gender" value="Nam" type="radio"></span>
                                            <span><label for="gender">Nữ</label><input name="gender" value="Nữ" type="radio"></span>
                                            <span><label for="gender">Khác</label><input name="gender" value="khác" type="radio"></span>
                                        </p>
                                    </div>
                                    <div class="group-input input-validate">
