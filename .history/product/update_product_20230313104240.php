...
function change_info_product(){
    ...
    $cate_address=$conn->query("SELECT DM_TEN FROM `DANHMUC` WHERE DM_ID=".$arr_change[0][1]." ");
    $room_address=$conn->query("SELECT DM_TEN FROM `DANHMUC` WHERE DM_ID=".$arr_change[0][1]." ");
    function render_item($arr_change){
      echo '    <p><span></span>/<span></span></p>                        ';
