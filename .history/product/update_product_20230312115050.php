...
function change_info_product(){
  ...
  if(isset($_GET["id_change"])){
    ...
    function render_item($arr_change){
      echo '    <form method="post" action="./add-product.php">';
      echo '    <input type="hidden" name="id-product" value="'. $arr_change[0][1].'"/>';
      ...
      echo '        <input type="text" name="name-product" value="'.$arr_change[0][3].'" placeholder="Nhap vao ten san pham"> ';
      echo '    </div> ';
      echo '    <div class="wrap-input"> ';
      echo '        <label for="name-product">Giá sản phẩm</label> ';
      echo '        <input type="text" name="price-product" value="'.$arr_change[0][4].'" placeholder="Nhap vao ten san pham"> ';
      echo '    </div> ';
      echo '    <div class="wrap-input"> ';
      ...
      echo '        <input type="file" name="img_1" placeholder="Nhap vao ten san pham"> ';
      echo '    </div> ';
      echo '    <div class="wrap-input"> ';
      echo '        <label for="name-product">Ảnh sản phẩm zoom</label> ';
      echo '        <input type="file" name="img_2" placeholder="Nhap vao ten san pham"> ';
      echo '    </div> ';
      echo '    <div class="wrap-input">';
