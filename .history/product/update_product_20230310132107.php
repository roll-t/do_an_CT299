...
echo '                                    <input type="file" name="img_detail_1" placeholder="Nhap vao ten san pham">';
echo '                                </div>';
echo '                                <div class="wrap-input img">';
echo '                                    <label for="name-product">Hình 2</label>';
echo '                                    <input type="file" name="img_detail_2" placeholder="Nhap vao ten san pham">';
echo '                                </div>';
echo '                                <div class="wrap-input img">';
echo '                                    <label for="name-product">Hình 3</label>';
echo '                                    <input type="file" name="img_detail_3" placeholder="Nhap vao ten san pham">';
echo '                                </div>';
echo '                                <div class="wrap-input img">';
echo '                                    <label for="name-product">Hình 4</label>';
echo '                                    <input type="file" name="img_detail_4" placeholder="Nhap vao ten san pham">';
echo '                                </div>';
echo '                                <div class="wrap-input">';
