...
$arr_ms=select_value_all("SELECT * FROM `mau_sac` where 1");

$arr_chl=select_value_all("SELECT * FROM `Chat_lieu` where 1");
...
function show_detail_product(){
  ...
  echo '                                        <input name="width" type="number" name="name-product" value='.$ct_sanpham[""].' min="1" placeholder="Ngang">';
