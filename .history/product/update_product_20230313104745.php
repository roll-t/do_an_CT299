...
function change_info_product(){
    ...
    $room_address=$conn->query("SELECT P_TEN FROM `phong` WHERE P_ID=".$arr_change[0][2]." ")->fetch_assoc();
    function render_item($arr_change,$cate_address,$room_address){
      ...
      echo '    <p style="background:white;padding:10px 5px;" ><span>'.$cate_address["DM_TEN"].'</span>/<span>'.$room_address["P_TEN"].'</span></p>';
