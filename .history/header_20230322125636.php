    ...
    <div class="headline">
                ...
                <div class="right-headline">
                  <?php include './search.php'?>
                    ...
                    <a href=<?php echo isset($link)?$link:'./account.php'?> class="account"><ion-icon name="person-circle-outline"></ion-icon><h3><?php echo isset($name_account)?$name_account:'./account.php'?></h3></a>
                </div>
    </div>
