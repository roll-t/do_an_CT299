                ...
                <div class="items-right-profile my-profile">
                    <div class="head">
                        ...
                        <div class="container-my-profile">
                            <div class="left">
                                <form action="">
                                    <div class="group-input input-vaidate">
                                    ...
                                    <div class="group-input phone-number">
                                        ...
                                        <?php 
                                            if(isset($phone_number)){
                                                echo '<div class="phone_number">'.$phone_number.'<a style="padding-left:10px;   " href="#" class="change_phone_number">Thay đổi</a></div>';
                                            }else{
                                                echo '<input name="phone" type="text" placeholder="Số điện thoại ">';
                                            }
                                        ?>
                                    </div>
                                    <div class="group-input gender input-vaidate">
                                        <span>Giới tính: </span>
                                        <p>
                                    ...
                                    <div class="group-input input-vaidate">
                                        <span>Địa Chỉ</span>
                                        <textarea placeholder="hello" name="" id="" cols="10" rows="3"></textarea>
                                    </div>
