...
function select_address(){
    const body_product=document.querySelectorAll(".body-add-product")[1]
    const catalog_list=body_product.querySelector(".body-add-product .address-save .get-cate-id .cate_id")
    const address_1=document.querySelectorAll(".address_1")[1]
