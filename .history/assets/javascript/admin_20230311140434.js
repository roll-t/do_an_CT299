    ...
    items.addEventListener("click",e=>{
        ...
        list_room.forEach((show,idx)=>{
            if(index===idx){
                ...
                items_prodcut.style.display="none";
                btn_filter.style.opacity="0";
                select.addEventListener("change",e=>{
                    const value_items=()=>(select.value)
                ...
                function get_room(){
                    $(".btn-change-room").click(function(){
                        ...
                        let items_prodcut=document.querySelector(".items-product-select")
                        items_prodcut.style.display='none';
                            return false;
                    })
...
function select_address(index){
    ...
    const catalog_list=body_product.querySelectorAll(".body-add-product .address-save .wrap-input select")[0]
