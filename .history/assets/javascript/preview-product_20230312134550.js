...
const value_input_1=document.querySelectorAll(".address-save .wrap-input select")[0];
const value_input_2=document.querySelectorAll(".address-save .wrap-input select")[1];
const id=[0,0];

value_input_1.addEventListener("change",e=>{
    id[0]=value_input_1.value;
})

value_input_2.addEventListener("change",e=>{
    id[0]=value_input_2.value;
})

btn_get_id.addEventListener("click",e=>{
    cate_id_hidden.value=value_input_1.value;
    rooms_id_hidden.value=value_input_2.value;
