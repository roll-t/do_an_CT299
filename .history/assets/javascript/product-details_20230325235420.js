...
const get_quantity=()=>{
    let next=document.querySelector(".quantity .right")
    let prve=document.querySelector(".quantity .left")
    const link =document.querySelector(".btn_by_now")
    const id_product=document.querySelector(".id_checkout_product")
    next.addEventListener("click",e=>{
        let number=document.querySelector(".quantity .center")
        link.href=`./checkout.php?id_product=${id_product}&quantity_product=${number.innerHTML}`
    })
    prve.addEventListener("click",e=>{
        let number=document.querySelector(".quantity .center")
        link.href=`./checkout.php?quantity_product=${number.innerHTML}`
    })
}
get_quantity()