...
function preview(){
    ...
    const img_1=document.querySelector(".left-detail .list-img .img-items img")
    const img_2=document.querySelector(".left-detail .list-img .img-items img")
    const img_3=document.querySelector(".left-detail .list-img .img-items img")
    const img_4=document.querySelector(".left-detail .list-img .img-items img")
    const img_5=document.querySelector(".left-detail .list-img .img-items img")
}
preview()