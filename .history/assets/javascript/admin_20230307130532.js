...
function sort_detali_product(){
        const get_cate_id=document.querySelectorAll(".body-detele-product .wrap-input select")[2]
        const get_rooms_id=document.querySelectorAll(".body-detele-product .wrap-input select")[3]
        const link=document.querySelector(".body-detele-product .sort_product_detail");
        const id=[0,0];
        var cate_id;
        var rooms_id;
        ...
        get_cate_id.addEventListener("change",e=>{
            ...
            id[0]=cate_id;
            link.href=`filter.php?sort_product_detail=${id}`;
        })
        ...
        $(".body-detele-product .sort_product_detail").click(function(){
                let url=this.href;
