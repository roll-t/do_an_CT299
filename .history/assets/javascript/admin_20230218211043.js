...
const btn_2=document.querySelectorAll(".menu-items .category-items")[0]
const btn_3=document.querySelectorAll(".menu-items .category-items")[0]
const btn_4=document.querySelectorAll(".menu-items .category-items")[0]
