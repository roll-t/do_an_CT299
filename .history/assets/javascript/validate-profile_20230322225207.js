...
function check_fill(input,text){
    input.value=="" && show_error(input,text) && (validate.fill=true);
}
...
btn_save.addEventListener("click",e=>{
    check_fill(name_client,"Không được bỏ trống Tên") && validate.fill==true
    validate.fill==true && check_fill(des_address,"Hông được để trống mô tả")
