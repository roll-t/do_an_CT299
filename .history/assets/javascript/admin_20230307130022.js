...
function sort_detali_product(){
        const cate_id=document.querySelectorAll(".body-detele-product .wrap-input select")[2]
        const rooms_id=document.querySelectorAll(".body-detele-product .wrap-input select")[3]
