...
function select_address(){
    const body_product=document.querySelectorAll("")[1]
    const catalog_list=body_product.querySelector(".body-add-product .address-save .wrap-input detele-catalog-list")
