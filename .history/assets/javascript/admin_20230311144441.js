...
function select_address(){
    const catalog_list=document.querySelector(".body-add-product .address-save .wrap-input:nth-child(1) select")
    const address_1=document.querySelector(".address_catalog_list")
        ...
        function get_cate(){
            $(".address_catalog_list").click(function(){
                    let url=this.href;
                    $(".body-add-product .address-save .wrap-input:nth-child(2) .get-cate-id").load(url)
                    return false;
            })


            $(".address_catalog_list").click()
        }
}
select_address();
