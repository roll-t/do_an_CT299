...
function preview(){
    ...
    btn.addEventListener("click",e=>{
        ...
        const price_pd=document.querySelectorAll(".left-side-add .wrap-input input")[0]
        const img_1_pd=document.querySelectorAll(".left-side-add .wrap-input input")[0]
        const img_2_pd=document.querySelectorAll(".left-side-add .wrap-input input")[0]
    })
