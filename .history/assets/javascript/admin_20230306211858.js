...
function select_address(index){
    ...
    const list_category=body_product.querySelectorAll(".address-save .wrap-input select")[0]
    const list_category=body_product.querySelectorAll(".address-save .wrap-input select")[2]
    const list_category=body_product.querySelectorAll(".address-save .wrap-input select")[3]
