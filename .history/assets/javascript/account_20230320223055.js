...
const btn_to_link=$(".link-account")
    btn_to_link.click(function(){
        this.href=`./client/check-name-account.php?name_account=${user_name.value}`;
...
btn_login.addEventListener("click",e=>{
   if(account){
    ...
    if(password_login.value===password){
        ...
        body_profile.brand.classList.add("active")
        body_profile.a.classList.add("active")
        form_peice.classList.add("none")
        form_signup.classList.add("none")
    }else{
