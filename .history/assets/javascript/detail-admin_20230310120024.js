...
function preview(){
    ...
    btn_preview.addEventListener("click",e=>{
        ...
        const content=`
                                    <li class="img-items">
                                        <img src="${link_1||images/collection/arrivals3.png}" alt="">
                                    </li>
                                    <li class="img-items">
                                        <img src="${link_2||images/collection/arrivals3.png}" alt="">
                                    </li>
                                    <li class="img-items">
                                        <img src="${link_3||images/collection/arrivals3.png}" alt="">
                                    </li>
                                    <li class="img-items">
                                        <img src="${link_4||images/collection/arrivals3.png}" alt="">
                                    </li>
                              `
