...
function check_address(input,text){
    ...
    select.value=="" && show_error(select,text) && (validate.address=false)
}
for(var i=2;i<=3;i++){
...
btn_save.addEventListener("click",e=>{
    validate.fill==false ? check_fill(name_client,"Không được bỏ trống Tên"):check_fill(des_address,"Hông được để trống mô tả") 
