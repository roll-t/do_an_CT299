                            ...
                            <div class="left">
                                <form action="#" method="get" >
                                    ...
                                    <div class="group-input gender input-validate">
                                        ...
                                        <?php
                                         if(isset($_COOKIE["account_homedesign"])){
                                            $gender=isset(explode(",",$_COOKIE[ "account_homedesign"])[3])?explode(",",$_COOKIE[ "account_homedesign"])[3]:false;
                                           if($gender){
                                            echo '<div class="gender_client">'.$gender.'</div>';
                                           }else{
                                           echo ' <p>';
                                           echo ' <span><label for="gender">Nam</label><input name="gender" value="Nam" type="radio"></span>';
                                           echo ' <span><label for="gender">Nữ</label><input name="gender" value="Nữ" type="radio"></span>';
                                           echo ' <span><label for="gender">Khác</label><input name="gender" value="khác" type="radio"></span>';
                                           echo ' </p>';
                                           }
                                        }
                                        ?>
                                    ...
                                    <div class="confrim-info">
                                        <a href="#" class="btn_confirm_info">Luu</a>
