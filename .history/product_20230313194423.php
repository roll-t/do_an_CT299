        ...
        <div class="container">
            <div  id="new-arrival" class="body-2 body-2-product">
                ...
                <ul class="list-product">
                    ...
                    $sql_product="SELECT * FROM `SANPHAM` LIMIT $start_page,$quntity_page";
                    ...
                    function render_list_product($arr_product){
                        ...
                        echo '<script src="./assets/javascript/to-detail-product.js"></script>';
                    }
                ...
                <?php
                    ...
                    echo '      <a href="./padding/padding-product.php?page=0" class="page-items next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
                    echo '      <a href="./padding/padding-product.php?page=0" class="page-items">1</a>';
                    echo '      <a href="./padding/padding-product.php?page=0" class="page-items">2</a>';
                    echo '      <a href="./padding/padding-product.php?page=0" class="page-items">3</a>';
                    echo '      <div class="texture">.....</div>';
                    echo '      <a href="./padding/padding-product.php?page=0" class="page-items prve"><ion-icon name="chevron-forward-outline"></ion-icon></a>';
                    echo '  </div>';
                ?>
