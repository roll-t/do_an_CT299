...
if(isset($_GET["page_next"])){
  $index=$_GET["page_next"]+1;
}else{
  $index=1;
}

if(isset($_GET["page_prve"])){
  $index=$_GET["page_prve"]-1;
}
...
function show_list($arr){
  ...
  if(count($arr)>0){  
    ...
    echo '</li>';
      ...
      echo '   <a class="page" href="./filter.php?page_prve='.$index_next.'" class="next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
      if(count($arr)>=10){
        echo '   <a class="page" href="./filter.php?page_next='.$index_next.'" class="next"><ion-icon name="chevron-forward-outline"></ion-icon></ion-icon></a>';
      }else{
