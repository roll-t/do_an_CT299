        ...
        <header id="top" class="header">
            <div class="headline">
                ...
                <div class="center-headline">
                    <nav class="menu">
                        <li class="menu-items active"><a href="#top">Trang Chủ</a></li>
                        <li class="menu-items"><a href="./product.php">Sản Phẩm</a></li>
                        <li class="menu-items"><a href="./room.php">Phòng</a></li>
                        <li class="menu-items"><a href="#blog">Góc Cảm Hứng</a></li>
                        <li class="menu-items"><a href="#contact">Liên Hệ</a></li>
                    </nav>
                </div>
