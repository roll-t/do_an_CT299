...
function show_list($arr){
  if(count($arr)>0){  
    ...
    if(count($arr)>=10){
      ...
      echo '   <a href="./filter.php?next-page" class="next"><ion-icon name="chevron-back-outline"></ion-icon></a>';
      echo '  <a href="./filter.php?prve-page" class="next"><ion-icon name="chevron-forward-outline"></ion-icon></ion-icon></a>';
      echo '   </div>';
      }
